...
const Login = () => {
  ...
  const handleSubmit = (e) =>{
    e.preventDefault();
    if(InicioData.usuario === "admin" && InicioData.password === "admin"){
      navigate("/admin");
    }
    if(InicioData.usuario === "profesor" && InicioData.password === "profesor"){
      navigate("/profesor")
    }
    if(InicioData.usuario === "estudiante" && InicioData.password === "estudiante"){
      navigate("/estudiante")
    }
  }
  return (
